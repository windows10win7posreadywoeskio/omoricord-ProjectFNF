...
class Startup extends MusicBeatState
{
	...
	override function create()
	{
        ...
        loadingText = new FlxText(5, FlxG.height - 30, 0, "preloading assets lmao", 24);
        loadingText.setFormat("assets/fonts/yourmom.ttf", 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
        add(loadingText);
